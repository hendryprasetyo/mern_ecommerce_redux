...
export const logout = () => (dispatch) => {
  ...
  localStorage.removeItem('shippingProcess')
...
export const listUsers = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`/api/auth/all-user`, config)
...
export const deleteUser = (id) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`/api/auth/user/${id}`, config)
...
export const updateUser = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`/api/auth/user/${user._id}`, user, config)
